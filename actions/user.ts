  ...
  try {
    ...
    if (needsInsightCreation && data.industry) {
      try {
        ...
        console.log("AI insight generation failed (non-blocking):", aiError.message);
        // Don't throw - allow onboarding to complete without insights
        // Insights will be generated later when quota is available
      }
    }
